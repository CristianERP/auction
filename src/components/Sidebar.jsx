...
const Sidebar = () => {
    ...
    return (
        <>
            <form>
                <input type="text" className="w-full py-1 pl-4 bg-white border rounded-sm shadow-sm placeholder:italic placeholder:text-slate-400 border-slate-300 focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm" placeholder="Buscar palabra clave" />
            </form>
